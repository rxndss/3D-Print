...
#define HOMING_BUMP_MM      { 5, 5, 2 } //{ 5, 5, 2 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 40, 40, 10 } //{ 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 133*60, 133*60, 7*60, 100 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
