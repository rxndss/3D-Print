...
#define STRING_CONFIG_H_AUTHOR "(Creality, Ender-3 V2)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Ender 3 v2
    #define DEFAULT_Kp  21.73 //28.72
    #define DEFAULT_Ki   1.54 //2.62
    #define DEFAULT_Kd  76.55 //78.81
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 10, 25 } //{ 500, 500, 5, 25 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 700, 700, 100, 5000 } //{ 500, 500, 100, 1000 }
...
#define XY_PROBE_FEEDRATE (200*60) //(50*60)
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   2 //10 // Z Clearance for Deploy/Stow
...
#define X_MIN_POS -10
#define Y_MIN_POS -11.2
#define Z_MIN_POS 0
#define X_MAX_POS 241 + X_MIN_POS
#define Y_MAX_POS 231 + Y_MIN_POS
...
#define HOMING_FEEDRATE_MM_M { (100*60), (100*60), (10*60) } //{ (50*60), (50*60), (4*60) }
...
#define PREHEAT_2_LABEL       "Change Nozzle"
#define PREHEAT_2_TEMP_HOTEND 285
