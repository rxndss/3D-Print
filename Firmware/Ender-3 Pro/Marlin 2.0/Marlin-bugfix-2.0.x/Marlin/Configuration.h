...
#define STRING_CONFIG_H_AUTHOR "(RS, Ender-3 Pro)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 260.35
  #define DEFAULT_bedKi 50.85
  #define DEFAULT_bedKd 888.67
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 3000, 3000, 300, 8000 } // ...or, set your own edit limits
#endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS), (Y_MIN_POS + 10), 20 }
